...
- Dive into **[Concepts](../concepts/data-model.md)** to understand collections, indexes, and partitions.
- Follow the **[Migrations guide](../concepts/migrations.md)** to manage schema drift safely.
- Skim **[Reference → Configuration](../reference/configuration.md)** for all available options.
